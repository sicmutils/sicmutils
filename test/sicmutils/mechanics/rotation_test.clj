...
(deftest hello
  (let [P (up 'x 'y 'z)]
    ...
    (is (= '(up 0 0 0) (simplify-and-freeze (- ((Rx 'a) P) (* (rotate-x-matrix 'a) P)))))
    (is (= '(up 0 0 0) (simplify-and-freeze (- ((Ry 'a) P) (* (rotate-y-matrix 'a) P)))))
    (is (= '(up 0 0 0) (simplify-and-freeze (- ((Rz 'a) P) (* (rotate-z-matrix 'a) P)))))))
