    ...
    (let-coordinates [[x y z] m/R3-rect]
      (let [R3-point ((m/point R3-rect) (up 'x0 'y0 'z0))
        ...
        (is (= '(+ (* -1 (u↑1 p) (f p) (w↑2 p) (v↑0 p))
                   ...
                   (* (f p) (u↑0 p) (v↑1 p) (w↑2 p))
                   (* -1 (f p) (u↑0 p) (w↑1 p) (v↑2 p))
                   (* -1 (f p) (v↑1 p) (w↑0 p) (u↑2 p))
                   (* (f p) (w↑1 p) (u↑2 p) (v↑0 p)))
               (present
        ...
        (is (= '(+ (* (u↑1 p) (v↑2 p) (alpha p))
                   (* -1 (u↑1 p) (v↑0 p) (gamma p))
                   (* (u↑0 p) (v↑1 p) (gamma p))
                   (* -1 (u↑0 p) (v↑2 p) (beta p))
        ...
        (is (= '(+ (* -1 (u↑1 p) (w↑2 p) (v↑0 p) (((partial 0) alpha) p))
                   ...
                   (* (u↑0 p) (v↑1 p) (w↑2 p) (((partial 0) alpha) p))
                   (* (u↑0 p) (v↑1 p) (w↑2 p) (((partial 1) beta) p))
                   (* (u↑0 p) (v↑1 p) (w↑2 p) (((partial 2) gamma) p))
                   (* -1 (u↑0 p) (w↑1 p) (v↑2 p) (((partial 0) alpha) p))
                   (* -1 (u↑0 p) (w↑1 p) (v↑2 p) (((partial 1) beta) p))
                   (* -1 (u↑0 p) (w↑1 p) (v↑2 p) (((partial 2) gamma) p))
                   (* -1 (v↑1 p) (w↑0 p) (u↑2 p) (((partial 0) alpha) p))
                   (* -1 (v↑1 p) (w↑0 p) (u↑2 p) (((partial 1) beta) p))
                   (* -1 (v↑1 p) (w↑0 p) (u↑2 p) (((partial 2) gamma) p))
                   (* (w↑1 p) (u↑2 p) (v↑0 p) (((partial 0) alpha) p))
                   (* (w↑1 p) (u↑2 p) (v↑0 p) (((partial 1) beta) p))
                   (* (w↑1 p) (u↑2 p) (v↑0 p) (((partial 2) gamma) p)))
               (present
                (((ff/d (E3-star omega))
                  (vf/literal-vector-field 'u R3-rect)
                  (vf/literal-vector-field 'v R3-rect)
