  ...
  (with-literal-functions
    ...
    (let [state (up 't (up 'x 'y 'X 'Y) (up 'dx 'dy 'dX 'dY))]
      ...
      (is (= '(/ (+ (* (expt dX 2) m2 (sqrt (+ (expt X 2) (* -2 X x) (expt Y 2) (* -2 Y y) (expt x 2) (expt y 2))))
             ...
             (simplify-and-freeze ((central/L 'm1 'm2) state))))
        ...
        (is (= '(down (/ (+ (* X m1 m2)
                      ...
                      (/ (+ (* -1 Y m1 m2) (* m1 m2 y))
                         (+ (* (expt X 2) (sqrt (+ (expt X 2) (* -2 X x) (expt Y 2) (* -2 Y y) (expt x 2) (expt y 2))))
                            ...
                            (* (expt x 2) (sqrt (+ (expt X 2) (* -2 X x) (expt Y 2) (* -2 Y y) (expt x 2) (expt y 2))))
                            (* (expt y 2) (sqrt (+ (expt X 2) (* -2 X x) (expt Y 2) (* -2 Y y) (expt x 2) (expt y 2)))))))
               (simplify-and-freeze (F state))))
        (is (= '(down (* dx m1)
                      (* dy m1)
                      (* dX m2)
                      (* dY m2))
               (simplify-and-freeze (P state))))
        (is (= '(down (/ (+ (* X m1 m2) (* -1 m1 m2 x))
                      ...
                      (/ (+ (* -1 Y m1 m2) (* m1 m2 y))
                         (+ (* (expt X 2) (sqrt (+ (expt X 2) (* -2 X x) (expt Y 2) (* -2 Y y) (expt x 2) (expt y 2))))
                            ...
                            (* (expt x 2) (sqrt (+ (expt X 2) (* -2 X x) (expt Y 2) (* -2 Y y) (expt x 2) (expt y 2))))
                            (* (expt y 2) (sqrt (+ (expt X 2) (* -2 X x) (expt Y 2) (* -2 Y y) (expt x 2) (expt y 2)))))))
               (simplify-and-freeze (N state))))
        (is (= '(down 0 0 0 0) (simplify-and-freeze ((- F N) state))))
        (is (= 4 (count (A state))))
      ...
      (is (= '(down (down (up (up (* m (((expt D 2) x) t))
                    ...
                    (down (up (up 0 0)
                          ...
                          (up (up 0 0)
                              (up 0 0))))
             (simplify-and-freeze (((Lagrange-equations (central/L 'm 'M))
                  ...
                  (up (/ (+ (* M X) (* -1 M x))
                      ...
                      (/ (+ (* -1 Y m) (* m y))
                         (+ (* (expt X 2) (sqrt (+ (expt X 2) (* -2 X x) (expt Y 2) (* -2 Y y) (expt x 2) (expt y 2))))
                            ...
                            (* (expt x 2) (sqrt (+ (expt X 2) (* -2 X x) (expt Y 2) (* -2 Y y) (expt x 2) (expt y 2))))
                            (* (expt y 2) (sqrt (+ (expt X 2) (* -2 X x) (expt Y 2) (* -2 Y y) (expt x 2) (expt y 2))))))))
             (simplify-and-freeze ((central/state-derivative 'm 'M) state))))
      (let [o (atom [])
