...
(deftest ^:long smoke
  ...
  (is (= '(up 1
              ...
              (up (/ (+ (* (expt (sin ψ) 2) (cos θ) (sin θ) (expt A 2) (expt φdot 2))
                        (* -1N (expt (sin ψ) 2) (cos θ) (sin θ) A C (expt φdot 2))
                        ...
                        (* -1N (expt (sin ψ) 2) (sin θ) A C φdot ψdot)
                        (* (sin ψ) (cos θ) (cos ψ) (expt A 2) θdot φdot)
                        (* -1N (sin ψ) (cos θ) (cos ψ) A C θdot φdot)
                        (* -1N (sin ψ) (cos θ) (cos ψ) (expt B 2) θdot φdot)
                        ...
                        (* -1N (sin ψ) (cos ψ) A C θdot ψdot)
                        (* -1N (sin ψ) (cos ψ) (expt B 2) θdot ψdot)
                        (* (sin ψ) (cos ψ) B C θdot ψdot)
                        (* -1N (sin θ) A B φdot ψdot))
                     (* A B))
                  (/ (+ (* -1N (sin ψ) (cos θ) (sin θ) (cos ψ) (expt A 2) (expt φdot 2))
                        (* (sin ψ) (cos θ) (sin θ) (cos ψ) A C (expt φdot 2))
                        (* (sin ψ) (cos θ) (sin θ) (cos ψ) (expt B 2) (expt φdot 2))
                        (* -1N (sin ψ) (cos θ) (sin θ) (cos ψ) B C (expt φdot 2))
                        (* -1N (expt (sin ψ) 2) (cos θ) (expt B 2) θdot φdot)
                        (* (expt (sin ψ) 2) (cos θ) B C θdot φdot)
                        (* -1N (sin ψ) (sin θ) (cos ψ) (expt A 2) φdot ψdot)
                        (* (sin ψ) (sin θ) (cos ψ) A C φdot ψdot)
                        (* (sin ψ) (sin θ) (cos ψ) (expt B 2) φdot ψdot)
                        (* -1N (sin ψ) (sin θ) (cos ψ) B C φdot ψdot)
                  ...
                  (/ (+ (* (sin ψ) (expt (cos θ) 2) (sin θ) (cos ψ) (expt A 2) C (expt φdot 2))
                        (* -1N (sin ψ) (expt (cos θ) 2) (sin θ) (cos ψ) A (expt C 2) (expt φdot 2))
                        (* -1N (sin ψ) (expt (cos θ) 2) (sin θ) (cos ψ) (expt B 2) C (expt φdot 2))
                        (* (sin ψ) (expt (cos θ) 2) (sin θ) (cos ψ) B (expt C 2) (expt φdot 2))
                        (* (sin ψ) (expt (sin θ) 3) (cos ψ) (expt A 2) B (expt φdot 2))
                        (* -1N (sin ψ) (expt (sin θ) 3) (cos ψ) A (expt B 2) (expt φdot 2))
                        ...
                        (* -1N (sin ψ) (cos θ) (sin θ) (cos ψ) A (expt C 2) φdot ψdot)
                        (* -1N (sin ψ) (cos θ) (sin θ) (cos ψ) (expt B 2) C φdot ψdot)
                        (* (sin ψ) (cos θ) (sin θ) (cos ψ) B (expt C 2) φdot ψdot)
                        (* (expt (cos θ) 2) (expt (cos ψ) 2) (expt A 2) C θdot φdot)
                        (* -1N (expt (cos θ) 2) (expt (cos ψ) 2) A (expt C 2) θdot φdot)
                        (* 2N (expt (sin θ) 2) (expt (cos ψ) 2) (expt A 2) B θdot φdot)
                        ...
                        (* -1N (sin ψ) (sin θ) (cos ψ) (expt A 2) B (expt θdot 2))
                        (* (sin ψ) (sin θ) (cos ψ) A (expt B 2) (expt θdot 2))
                        (* (cos θ) (expt (cos ψ) 2) (expt A 2) C θdot ψdot)
                        (* -1N (cos θ) (expt (cos ψ) 2) A (expt C 2) θdot ψdot)
