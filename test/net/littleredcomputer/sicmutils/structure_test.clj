...
(ns net.littleredcomputer.sicmutils.structure-test
...
(deftest structures
  (testing "type"
    (is (= :net.littleredcomputer.sicmutils.structure/up (v/kind (up 1 2))))
    (is (= :net.littleredcomputer.sicmutils.structure/down (v/kind (down (up 1 2) (up 2 3))))))
  (testing "s+t"
  ...
  (testing "function - rotate about x axis"
    ...
    (is (= (up 'x (net.littleredcomputer.sicmutils.generic/- 'z) 'y) ((Rx 'pi-over-2) (up 'x 'y 'z)))))
  (testing "dot-product"
...
(deftest matrices
  (let [A (up (up 1 2) (up 3 4))
    ...
    (testing "square?"
      (is (= [2 :net.littleredcomputer.sicmutils.structure/up :net.littleredcomputer.sicmutils.structure/up] (square? A)))
      (is (not (square? B)))
      (is (= [3 :net.littleredcomputer.sicmutils.structure/down :net.littleredcomputer.sicmutils.structure/up] (square? C)))
      (is (= [1 :net.littleredcomputer.sicmutils.structure/up :net.littleredcomputer.sicmutils.structure/down] (square? D)))
      (is (square? E)))
    (testing "determinant"
      (is (= -2 (determinant A)))
      (is (= 22 (determinant C)))
