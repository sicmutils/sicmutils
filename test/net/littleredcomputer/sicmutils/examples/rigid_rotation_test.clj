...
(ns net.littleredcomputer.sicmutils.examples.rigid-rotation-test
  (:refer-clojure :exclude [+ - * / zero? partial])
  (:require [clojure.test :refer :all]
            [net.littleredcomputer.sicmutils.env :refer :all]
            [net.littleredcomputer.sicmutils.examples.rigid-rotation :as rigid-rotation]
            [net.littleredcomputer.sicmutils.mechanics.rigid :as rigid]))
