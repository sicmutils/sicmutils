...
(def ^:private orientation->symbol {:net.littleredcomputer.math.structure/up "↑"
...
(derive :net.littleredcomputer.math.expression/numerical-expression ::cofunction)
(derive :net.littleredcomputer.math.structure/structure ::cofunction)
(derive :net.littleredcomputer.math.value/function ::function)
