...
(ns net.littleredcomputer.sicmutils.calculus.derivative
...
(defn- define-binary-operation
  ...
  (doseq [signature [[::differential ::differential]
                     [:net.littleredcomputer.sicmutils.expression/numerical-expression ::differential]
                     [::differential :net.littleredcomputer.sicmutils.expression/numerical-expression]]]
...
(derive ::differential :net.littleredcomputer.sicmutils.function/cofunction)

(defmethod g/partial-derivative
  [:net.littleredcomputer.sicmutils.function/function Sequential]
  [f selectors]
  (multivariate-derivative f selectors))

(defmethod g/partial-derivative
  [:net.littleredcomputer.sicmutils.structure/structure Sequential]
  [f selectors]
  (multivariate-derivative f selectors))
