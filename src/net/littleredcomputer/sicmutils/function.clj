...
(ns net.littleredcomputer.sicmutils.function
  ...
  (:import [net.littleredcomputer.sicmutils.polynomial Polynomial]
           [net.littleredcomputer.sicmutils.structure Struct]
           [net.littleredcomputer.sicmutils.operator Operator]
           (clojure.lang IFn)))
...
(def ^:private orientation->symbol {:net.littleredcomputer.sicmutils.structure/up "↑"
                                    :net.littleredcomputer.sicmutils.structure/down "_"})
...
(derive :net.littleredcomputer.sicmutils.expression/numerical-expression ::cofunction)
(derive :net.littleredcomputer.sicmutils.structure/structure ::cofunction)
(derive :net.littleredcomputer.sicmutils.value/function ::function)
