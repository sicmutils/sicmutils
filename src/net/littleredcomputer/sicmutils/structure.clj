...
(ns net.littleredcomputer.sicmutils.structure
...
(defmethod g/mul [::structure :net.littleredcomputer.sicmutils.expression/numerical-expression] [a b] (outer-product b a))
(defmethod g/mul [:net.littleredcomputer.sicmutils.expression/numerical-expression ::structure] [a b] (outer-product a b))
(defmethod g/mul [::structure :net.littleredcomputer.sicmutils.calculus.derivative/differential] [a b] (outer-product b a))
(defmethod g/mul [:net.littleredcomputer.sicmutils.calculus.derivative/differential ::structure] [a b] (outer-product a b))
(defmethod g/div [::structure :net.littleredcomputer.sicmutils.expression/numerical-expression] [a b] (outer-product (g/invert b) a))
