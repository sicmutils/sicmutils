...
(ns net.littleredcomputer.sicmutils.numerical.integrate
  (:require [clojure.tools.logging :as log]
            [net.littleredcomputer.sicmutils.numerical.compile :refer :all]
            [net.littleredcomputer.sicmutils.numbers])
