...
(ns net.littleredcomputer.sicmutils.rational-function
  ...
  (:import [clojure.lang Ratio BigInt]
           [net.littleredcomputer.sicmutils.polynomial Polynomial]))
...
(defmethod g/add [::rational-function :net.littleredcomputer.sicmutils.polynomial/polynomial] [r p] (addp r p))
(defmethod g/add [:net.littleredcomputer.sicmutils.polynomial/polynomial ::rational-function] [p r] (addp r p))

(defmethod g/sub
  [::rational-function :net.littleredcomputer.sicmutils.polynomial/polynomial]
  [r p]
  (addp r (g/negate p)))

(defmethod g/sub
  [:net.littleredcomputer.sicmutils.polynomial/polynomial ::rational-function]
  [p r]
  (addp (g/negate r) p))
...
(defmethod g/sub [::rational-function :net.littleredcomputer.sicmutils.polynomial/polynomial] [r p] (subp r p))
...
(defmethod g/mul
  [Ratio :net.littleredcomputer.sicmutils.polynomial/polynomial]
  [r p]
  (make (g/mul (numerator r) p)
        (p/make-constant (:arity p) (denominator r))))

(defmethod g/mul
  [:net.littleredcomputer.sicmutils.polynomial/polynomial Ratio]
  [p r]
...
(defmethod g/div
  [:net.littleredcomputer.sicmutils.polynomial/polynomial :net.littleredcomputer.sicmutils.polynomial/polynomial]
  [p q]
  (let [g (gcd p q)]
    (make (p/evenly-divide p g) (p/evenly-divide q g))))

(defmethod g/div
  [Long :net.littleredcomputer.sicmutils.polynomial/polynomial]
  [c p]
  (make (p/make-constant (:arity p) c) p))

(defmethod g/div
  [BigInt :net.littleredcomputer.sicmutils.polynomial/polynomial]
  [c p]
  (make (p/make-constant (:arity p) c) p))

(defmethod g/div
  [:net.littleredcomputer.sicmutils.polynomial/polynomial Long]
  [p c]
  (make p (p/make-constant (:arity p) c)))

(defmethod g/div
  [:net.littleredcomputer.sicmutils.polynomial/polynomial BigInt]
  [p c]
  (make p (p/make-constant (:arity p) c)))
