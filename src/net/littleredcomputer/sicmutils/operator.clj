...
(ns net.littleredcomputer.sicmutils.operator
...
;; number.
(defmethod g/add [::operator :net.littleredcomputer.sicmutils.expression/numerical-expression]
  [o n]
  (add o (number->operator n)))

(defmethod g/sub [::operator ::operator] [o p] (sub o p))
(defmethod g/sub
  [::operator :net.littleredcomputer.sicmutils.expression/numerical-expression]
  [o n]
...
(defmethod g/mul
  [::operator :net.littleredcomputer.sicmutils.function/function]
  [o f]
  (mul o (function->operator f)))

(defmethod g/mul
  [:net.littleredcomputer.sicmutils.function/function ::operator]
  [f o]
