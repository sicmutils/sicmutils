...
(ns net.littleredcomputer.sicmutils.numsymb
...
(defn- define-binary-operation
  ...
  (defmethod generic-operation [:net.littleredcomputer.sicmutils.expression/numerical-expression
                                :net.littleredcomputer.sicmutils.expression/numerical-expression]
    [a b]
...
(derive Symbol :net.littleredcomputer.sicmutils.expression/numerical-expression)
(derive Number :net.littleredcomputer.sicmutils.expression/numerical-expression)
