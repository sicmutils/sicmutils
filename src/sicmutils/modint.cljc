...
(defmethod g/integer-part [::modint] [a] (make (g/integer-part (:i a)) (:m a)))
(defmethod g/fractional-part [::modint] [a] (make (g/fractional-part (:i a)) (:m a)))
(defmethod g/floor [::modint] [a] (make (g/floor (:i a)) (:m a)))
(defmethod g/ceiling [::modint] [a] (make (g/ceiling (:i a)) (:m a)))
