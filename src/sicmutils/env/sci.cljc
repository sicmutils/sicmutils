...
(def ^{:doc "Map whose values are the symbols of of all namespaces explicitly
 ...
 corresponding namespace."}
  ...
  {'pattern.consequence                      (ns-publics 'pattern.consequence)
   ...
   'sicmutils.mechanics.noether              (ns-publics 'sicmutils.mechanics.noether)
   ...
   'sicmutils.mechanics.routhian             (ns-publics 'sicmutils.mechanics.routhian)
   'sicmutils.mechanics.time-evolution       (ns-publics 'sicmutils.mechanics.time-evolution)
