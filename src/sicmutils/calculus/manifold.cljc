...
(defprotocol ICoordinateSystem
  ...
  (coordinate-prototype [this]
    "Returns this [[ICoordinateSystem]]'s symbolic coordinate prototype. This is
  ...
  (with-coordinate-prototype [this coordinate-prototype]
    "Returns a version of this [[ICoordinateSystem]] with the new
    `coordinate-prototype` installed.")
...
(defn- ->SpacetimeSpherical
  ...
  ([manifold coordinate-prototype]
   (reify ICoordinateSystem
     ...
     (with-coordinate-prototype [this prototype]
       ;; TODO This is the source of my woes...
       this
  ...
  ([manifold coordinate-prototype]
   (let [n (:dimension manifold)]
     (reify ICoordinateSystem
       ...
       (with-coordinate-prototype [this prototype]
         (->Euler-chart manifold prototype))
  ...
  ([manifold coordinate-prototype]
   (let [n (:dimension manifold)]
     (reify ICoordinateSystem
       ...
       (with-coordinate-prototype [this prototype]
         (->Alternate-chart manifold prototype))
