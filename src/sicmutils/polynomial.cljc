...
;; TODO remove this... just do it via the generic installation.
...
;; TODO: from pcf, keep? or do `v/scalar?`
...
(defmethod v/= [::v/number ::polynomial] [l r]
  (poly:= r l))
